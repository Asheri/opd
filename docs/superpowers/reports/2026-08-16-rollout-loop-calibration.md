...
> 日期：2026-08-16 ｜ 状态：待服务器真实 rollout 数据填充 ｜ 模型：Qwen3-1.7B ｜ N=100（待跑） ｜ max_new=待定 ｜ eos_token_id=151645 ｜ 人工标注：无
...
> **（无数据）**：真实 rollout 100 条需服务器 GPU，本机无 GPU 未伪造通过；
> 此表为占位，待服务器 `calibrate_rollout.py --n 100 --report ...` 填充。
